...
namespace SolidHttp.Providers
{
    ...
    {
        private ConcurrentDictionary<string, IResponseDeserializerFactory> _factories = new ConcurrentDictionary<string, IResponseDeserializerFactory>(StringComparer.OrdinalIgnoreCase);
